...
nonisolated struct CMsgClientHeartBeat: Sendable {
  ...
  var hasSendReply: Bool {self._sendReply != nil}
...
nonisolated struct CMsgClientServerTimestampRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasClientRequestTimestamp: Bool {self._clientRequestTimestamp != nil}
...
nonisolated struct CMsgClientServerTimestampResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasServerTimestampMs: Bool {self._serverTimestampMs != nil}
...
nonisolated struct CMsgClientSecret: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientHello: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientLogon: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasDeprecatedObfustucatedPrivateIp: Bool {_storage._deprecatedObfustucatedPrivateIp != nil}
  ...
  var hasCellID: Bool {_storage._cellID != nil}
  ...
  var hasLastSessionID: Bool {_storage._lastSessionID != nil}
  ...
  var hasClientPackageVersion: Bool {_storage._clientPackageVersion != nil}
  ...
  var hasClientLanguage: Bool {_storage._clientLanguage != nil}
  ...
  var hasClientOsType: Bool {_storage._clientOsType != nil}
  ...
  var hasShouldRememberPassword: Bool {_storage._shouldRememberPassword != nil}
  ...
  var hasWineVersion: Bool {_storage._wineVersion != nil}
  ...
  var hasDeprecated10: Bool {_storage._deprecated10 != nil}
  ...
  var hasObfuscatedPrivateIp: Bool {_storage._obfuscatedPrivateIp != nil}
  ...
  var hasDeprecatedPublicIp: Bool {_storage._deprecatedPublicIp != nil}
  ...
  var hasQosLevel: Bool {_storage._qosLevel != nil}
  ...
  var hasClientSuppliedSteamID: Bool {_storage._clientSuppliedSteamID != nil}
  ...
  var hasPublicIp: Bool {_storage._publicIp != nil}
  ...
  var hasMachineID: Bool {_storage._machineID != nil}
  ...
  var hasUiMode: Bool {_storage._uiMode != nil}
  ...
  var hasChatMode: Bool {_storage._chatMode != nil}
  ...
  var hasSteam2AuthTicket: Bool {_storage._steam2AuthTicket != nil}
  ...
  var hasEmailAddress: Bool {_storage._emailAddress != nil}
  ...
  var hasRtime32AccountCreation: Bool {_storage._rtime32AccountCreation != nil}
  ...
  var hasAccountName: Bool {_storage._accountName != nil}
  ...
  var hasGameServerToken: Bool {_storage._gameServerToken != nil}
  ...
  var hasLoginKey: Bool {_storage._loginKey != nil}
  ...
  var hasWasConvertedDeprecatedMsg: Bool {_storage._wasConvertedDeprecatedMsg != nil}
  ...
  var hasAnonUserTargetAccountName: Bool {_storage._anonUserTargetAccountName != nil}
  ...
  var hasResolvedUserSteamID: Bool {_storage._resolvedUserSteamID != nil}
  ...
  var hasEresultSentryfile: Bool {_storage._eresultSentryfile != nil}
  ...
  var hasShaSentryfile: Bool {_storage._shaSentryfile != nil}
  ...
  var hasAuthCode: Bool {_storage._authCode != nil}
  ...
  var hasOtpType: Bool {_storage._otpType != nil}
  ...
  var hasOtpValue: Bool {_storage._otpValue != nil}
  ...
  var hasOtpIdentifier: Bool {_storage._otpIdentifier != nil}
  ...
  var hasSteam2TicketRequest: Bool {_storage._steam2TicketRequest != nil}
  ...
  var hasSonyPsnTicket: Bool {_storage._sonyPsnTicket != nil}
  ...
  var hasSonyPsnServiceID: Bool {_storage._sonyPsnServiceID != nil}
  ...
  var hasCreateNewPsnLinkedAccountIfNeeded: Bool {_storage._createNewPsnLinkedAccountIfNeeded != nil}
  ...
  var hasSonyPsnName: Bool {_storage._sonyPsnName != nil}
  ...
  var hasGameServerAppID: Bool {_storage._gameServerAppID != nil}
  ...
  var hasSteamguardDontRememberComputer: Bool {_storage._steamguardDontRememberComputer != nil}
  ...
  var hasMachineName: Bool {_storage._machineName != nil}
  ...
  var hasMachineNameUserchosen: Bool {_storage._machineNameUserchosen != nil}
  ...
  var hasCountryOverride: Bool {_storage._countryOverride != nil}
  ...
  var hasClientInstanceID: Bool {_storage._clientInstanceID != nil}
  ...
  var hasTwoFactorCode: Bool {_storage._twoFactorCode != nil}
  ...
  var hasSupportsRateLimitResponse: Bool {_storage._supportsRateLimitResponse != nil}
  ...
  var hasWebLogonNonce: Bool {_storage._webLogonNonce != nil}
  ...
  var hasPriorityReason: Bool {_storage._priorityReason != nil}
  ...
  var hasEmbeddedClientSecret: Bool {_storage._embeddedClientSecret != nil}
  ...
  var hasDisablePartnerAutogrants: Bool {_storage._disablePartnerAutogrants != nil}
  ...
  var hasIsChromeOs: Bool {_storage._isChromeOs != nil}
  /// Clears the value of `isChromeOs`. Subsequent reads from it will return its default value.
  mutating func clearIsChromeOs() {_uniqueStorage()._isChromeOs = nil}
...
nonisolated struct CMsgClientLogonResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasLegacyOutOfGameHeartbeatSeconds: Bool {_storage._legacyOutOfGameHeartbeatSeconds != nil}
  ...
  var hasHeartbeatSeconds: Bool {_storage._heartbeatSeconds != nil}
  ...
  var hasRtime32ServerTime: Bool {_storage._rtime32ServerTime != nil}
  ...
  var hasAccountFlags: Bool {_storage._accountFlags != nil}
  ...
  var hasEmailDomain: Bool {_storage._emailDomain != nil}
  ...
  var hasSteam2Ticket: Bool {_storage._steam2Ticket != nil}
  ...
  var hasEresultExtended: Bool {_storage._eresultExtended != nil}
  ...
  var hasCellIDPingThreshold: Bool {_storage._cellIDPingThreshold != nil}
  ...
  var hasDeprecatedUsePics: Bool {_storage._deprecatedUsePics != nil}
  ...
  var hasVanityURL: Bool {_storage._vanityURL != nil}
  ...
  var hasUserCountry: Bool {_storage._userCountry != nil}
  /// Clears the value of `userCountry`. Subsequent reads from it will return its default value.
  mutating func clearUserCountry() {_uniqueStorage()._userCountry = nil}
  ...
  var hasIpCountryCode: Bool {_storage._ipCountryCode != nil}
  ...
  var hasParentalSettings: Bool {_storage._parentalSettings != nil}
  ...
  var hasParentalSettingSignature: Bool {_storage._parentalSettingSignature != nil}
  ...
  var hasCountLoginfailuresToMigrate: Bool {_storage._countLoginfailuresToMigrate != nil}
  ...
  var hasCountDisconnectsToMigrate: Bool {_storage._countDisconnectsToMigrate != nil}
  ...
  var hasOgsDataReportTimeWindow: Bool {_storage._ogsDataReportTimeWindow != nil}
  ...
  var hasForceClientUpdateCheck: Bool {_storage._forceClientUpdateCheck != nil}
  ...
  var hasAgreementSessionURL: Bool {_storage._agreementSessionURL != nil}
  ...
  var hasFamilyGroupID: Bool {_storage._familyGroupID != nil}
  /// Clears the value of `familyGroupID`. Subsequent reads from it will return its default value.
  mutating func clearFamilyGroupID() {_uniqueStorage()._familyGroupID = nil}
...
nonisolated struct CMsgClientRequestWebAPIAuthenticateUserNonce: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasTokenType: Bool {self._tokenType != nil}
...
nonisolated struct CMsgClientRequestWebAPIAuthenticateUserNonceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasWebapiAuthenticateUserNonce: Bool {self._webapiAuthenticateUserNonce != nil}
...
nonisolated struct CMsgClientLogOff: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientLoggedOff: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientNewLoginKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasUniqueID: Bool {self._uniqueID != nil}
  ...
  /// Returns true if `loginKey` has been explicitly set.
  var hasLoginKey: Bool {self._loginKey != nil}
  /// Clears the value of `loginKey`. Subsequent reads from it will return its default value.
...
nonisolated struct CMsgClientNewLoginKeyAccepted: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientAccountInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasPersonaName: Bool {self._personaName != nil}
  ...
  var hasIpCountry: Bool {self._ipCountry != nil}
  ...
  var hasCountAuthedComputers: Bool {self._countAuthedComputers != nil}
  ...
  /// Returns true if `accountFlags` has been explicitly set.
  var hasAccountFlags: Bool {self._accountFlags != nil}
  /// Clears the value of `accountFlags`. Subsequent reads from it will return its default value.
  ...
  var hasSteamguardMachineNameUserChosen: Bool {self._steamguardMachineNameUserChosen != nil}
  ...
  var hasIsPhoneVerified: Bool {self._isPhoneVerified != nil}
  ...
  var hasTwoFactorState: Bool {self._twoFactorState != nil}
  ...
  var hasIsPhoneIdentifying: Bool {self._isPhoneIdentifying != nil}
  ...
  var hasIsPhoneNeedingReverify: Bool {self._isPhoneNeedingReverify != nil}
...
nonisolated struct CMsgClientChallengeRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CMsgClientChallengeResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension CMsgClientHeartBeat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}send_reply\0")
...
nonisolated extension CMsgClientServerTimestampRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}client_request_timestamp\0")
...
nonisolated extension CMsgClientServerTimestampResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}client_request_timestamp\0\u{3}server_timestamp_ms\0")
...
nonisolated extension CMsgClientSecret: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}version\0\u{1}appid\0\u{1}deviceid\0\u{1}nonce\0\u{1}hmac\0")
...
nonisolated extension CMsgClientHello: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}protocol_version\0")
...
nonisolated extension CMsgClientRequestWebAPIAuthenticateUserNonce: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}token_type\0")
...
nonisolated extension CMsgClientRequestWebAPIAuthenticateUserNonceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}eresult\0\u{4}\u{2}token_type\0\u{4}\u{8}webapi_authenticate_user_nonce\0")
...
nonisolated extension CMsgClientNewLoginKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}unique_id\0\u{3}login_key\0")
...
nonisolated extension CMsgClientNewLoginKeyAccepted: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}unique_id\0")
